 ...
 */
public abstract class DefaultSpecification<T, C> extends AbstractEventConditionBuilder<T, C> implements Specification<T> {

    public DefaultSpecification(C condition) {
        super(condition);
    }
